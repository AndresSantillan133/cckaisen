...
const Ticket = forwardRef<HTMLDivElement, TicketProps>(function Ticket(
  ...
  return (
    <div
      ref={ref}
      className="mx-auto w-full max-w-sm bg-[#ffffff] px-6 py-7 font-mono text-[13px] leading-snug text-[#000000]"
      style={{
        backgroundImage:
    ...
    >
      <header className="text-center">
        ...
        <p className="mt-1 text-[11px] uppercase tracking-[0.2em] text-[#737373]">
          Orden de compra
        </p>
      </header>

      <div className="my-4 border-t border-dashed border-[rgba(0,0,0,0.4)]" />
      ...
      <div className="text-[12px]">
        <p className="font-semibold uppercase tracking-wide text-[#737373]">
          Cliente
        </p>
        <p className="mt-1">{customer.name}</p>
        <p>{customer.phone}</p>
        <p className="mt-2 font-semibold uppercase tracking-wide text-[#737373]">
          Entrega
        </p>
        ...
        {customer.references && (
          <p className="text-[#737373]">Ref: {customer.references}</p>
        )}
      </div>
      ...
      <p className="text-center text-[10px] text-[#a3a3a3]">
        Presenta este ticket como comprobante de tu pedido
      </p>

      <div className="mt-4">
        <BarcodeStripe />
        <p className="mt-1 text-center text-[10px] tracking-[0.3em] text-[#737373]">
          {orderNumber}
        </p>
      </div>
    </div>
